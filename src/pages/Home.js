...
const Home = ({ setActive, user, active }) => {
  ...
  const [blogs, setBlogs] = useState([]); // Assuming 'blogs' is your state holding blog data
 ...
 // Assuming 'blogs' is your state holding blog data
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure wanted to delete that blog ?")) {
      try {
        ...
        // Update the UI after deletion by removing the deleted blog from state
